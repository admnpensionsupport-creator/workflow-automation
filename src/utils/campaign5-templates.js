 ...
 *
 * Email 1 (Day 1): Focus on the Pension Math & Simple Reply Question
 * Email 2 (Day 4): Value Drop – Account Efficiency & Hidden Fees
 * Email 3 (Day 7): Direct Call to Action & Booking Link
 *
...
export function campaign5Email3(name, contactId) {
  ...
  const html = wrapHtml(`
    ...
    <p>Spaces on our calendar for this round of reviews are filling up quickly. Please take 60 seconds to lock in a brief 15-minute slot that works around your school schedule:</p>
    ${trackedButton(contactId, 'Schedule Your 15-Minute Retirement Review')}
...
Spaces on our calendar for this round of reviews are filling up quickly. Please take 60 seconds to lock in a brief 15-minute slot that works around your school schedule:

Schedule Your 15-Minute Retirement Review: ${CALENDLY_LINK}
