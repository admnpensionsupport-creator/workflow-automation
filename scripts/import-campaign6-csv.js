/**
 * IMPORT: Load contacts from a CSV into the "Cold Email Campaign 6" table.
 *
 ...
 *   node scripts/import-campaign6-csv.js data/campaign6-contacts.csv --dry-run
 */
...
if (!csvPath) {
  console.error('Usage: node scripts/import-campaign6-csv.js <csv-path> [--dry-run]');
  process.exit(1);
}
