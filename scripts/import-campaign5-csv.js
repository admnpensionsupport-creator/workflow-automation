/**
 * IMPORT: Load contacts from a CSV into the "Cold Email Campaign 5" table.
 *
 ...
 *   node scripts/import-campaign5-csv.js data/campaign5-contacts.csv --dry-run
 */
...
if (!csvPath) {
  console.error('Usage: node scripts/import-campaign5-csv.js <csv-path> [--dry-run]');
  process.exit(1);
}
...
async function main() {
  ...
  for (const r of csvRows) {
    ...
    const district = (r.District || r.School || '').trim() || null;
