/**
 * IMPORT: Load contacts from a CSV into the "Cold Email Campaign 4" table.
 *
 * Expected CSV columns: First Name,Last Name,Email,Title,District
 *
 * Usage:
 *   node scripts/import-campaign4-csv.js data/campaign4-contacts.csv
 *   node scripts/import-campaign4-csv.js data/campaign4-contacts.csv --dry-run
 */
...
if (!csvPath) {
  console.error('Usage: node scripts/import-campaign4-csv.js <csv-path> [--dry-run]');
  process.exit(1);
}
